...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function setupChatInterface() {
        ...
        console.log(chatInterface, toggleChatButton, sendButton, chatInput);  // Debugging output

        if (toggleChatButton && chatInterface) {
            toggleChatButton.addEventListener('click', function() {
                if (chatInterface.style.display === 'none') {
                    chatInterface.style.display = 'block';
                    toggleChatButton.textContent = '⬇️';
                } else {
            ...
            console.error('Chat toggle button or chat interface is not found in the DOM');
        }
            ...
            sendButton.addEventListener('click', function() {
                ...
                if (message) {
                    ...
                    fetchChatGPTResponse(message).then(response => {
                        ...
                        appendMessage('Sorry, unable to respond at the moment.', 'ai');
                    });
                }
            });
        } else {
            console.error('Send button or chat input is not found in the DOM');
        }
        ...
        function appendMessage(message, sender) {
            ...
            if (chatBody) {
                ...
                chatBody.scrollTop = chatBody.scrollHeight; // Automatically scroll to the bottom
            } else {
                console.error('Chat body is not found in the DOM');
            }
        }
    }

    // Function to simulate fetching response from ChatGPT
    function fetchChatGPTResponse(message) {
