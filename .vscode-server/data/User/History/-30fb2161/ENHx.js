...
function fetchSummaryAndImages(topic) {
    ...
    const summaryPrompt = `In less than 200 words and avoiding the words "middle school":
        What is ${topic}?
        Explain ${topic} for a middle school student, focusing on key concepts and their relevance.
