...
function generateSimilarArticle() {
    ...
    if (!topic) {
        alert('No topic found. Generate an article first.');
        return;
    }

    let prompt = `Please generate a similar random topic related to the genre of ${randomTopic}, like if genre is sports then it could generate like what is basketball or what is cricket?`;
