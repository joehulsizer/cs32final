...
function generateSimilarArticle() {
    ...
    let prompt = `Please generate a similar random topic related to the genre of ${topic}, like if genre is sports then it could generate like what is basketball or what is cricket?`;
