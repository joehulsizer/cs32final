...
function generateQuiz() {
    ...
    // Assume quiz generation process here...

    // After quiz generation, hide the loading screen and show the quiz screen
    document.getElementById('loading-screen').style.display = 'none';
    ...
    for (let article of savedArticles) {
        try {
            let questionText = fetchChatGPTResponse(`Generate a multiple-choice question based on the following summary: ${article.summary}`);
            let question = {
                title: article.title,
