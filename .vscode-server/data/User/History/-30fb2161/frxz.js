...
function fetchImageFromGoogle(topic) {
    const apiKey = process.env.GOOGLE_API_KEY;  // Access environment variable
    const searchEngineId = process.env.GOOGLE_SEARCH_ENGINE_ID; // Replace with your search engine ID.
    const query = topic;
